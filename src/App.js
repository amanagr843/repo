...
import introduction from './assets/img/introduction-visual.png';
import victory from "./assets/img/work-victory.jpg";
import smith from "./assets/img/work-metiew-smith.jpg"
import nowak from  "./assets/img/work-alex-nowak.jpg";
import about from "./assets/img/work-alex-nowak.jpg"
import main from "./assets/img/work-alex-nowak.jpg"
function App() {
  return (
    <html lang="en">
    <head>
              ...
              <li class="l-section section section--is-active">
                <div class="intro">
                  <div class="intro--banner">
                    ...
                    <img src={introduction} alt="Welcome"/>
                  </div>
                  ...
                  <div class="work--lockup">
                    <ul class="slider">
                      ...
                      <li class="slider--item slider--item-center">
                        <a href="#0">
                          <div class="slider--item-image">
                            <img src={smith} alt="Metiew and Smith"/>
                          </div>
